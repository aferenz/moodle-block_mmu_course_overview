...
/**
 * Move/order course functionality for mmu_course_overview block.
 *
...
list($courses_sorted, $sitecourses, $coursecount) = block_mmu_course_overview_get_sorted_courses();
...
block_mmu_course_overview_update_myorder($neworder);
